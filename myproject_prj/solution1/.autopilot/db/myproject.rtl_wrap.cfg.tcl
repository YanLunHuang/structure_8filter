...
set DataType0 [list "nnet::array<ap_fixed<16, 14, 5, 3, 0>, 8>" "struct array" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "nnet::array<ap_fixed<16, 14, 5, 3, 0>, 8>" "struct array" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
